/**
 * Single Choice Options Component (Radio Buttons)
 *
...
interface OptionsSingleChoiceProps {
...
export function OptionsSingleChoice({
  options,
  selectedOptions,
  onSelect,
  hasSubmitted,
    ...
    >
      {options.map((option) => (
        <div
          ...
          onClick={() => !disabled && !hasSubmitted && onSelect(option.id)}
        >
          <RadioGroupItem
            value={option.id}
            id={option.id}
